...
-------------------------------------------------
 ...
 Fax number          2                          
 Web site            httptelerikacademy.com 
...
_Examples_
  ...
  a      b        c                          result                    
-----------------------------------------------------------------
 254  11.6     0.5      `FE        0011111110     11.600.500     ` 
 499  -0.5559  10000    `1F3       0111110011     -0.5610000     ` 
...
### Problem 6.	Quadratic Equation
	Write a program that reads the coefficients `a`, `b` and `c` of a quadratic equation axsup2sup + bx + c = 0 and solves it (prints its real roots).
